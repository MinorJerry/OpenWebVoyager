...
def build_vision_projector_megatron(language_transformer_config, vision_transformer_config, delay_load=False, **kwargs):
...
if __name__ == '__main__':
    ...
    torch.save(mm_projector.state_dict(), '/path/to/mm_projector_7B_to_70B.pth')
    exit()
    import transformers 
